  ...
  export default function BasketSidebar({ children }: { children: React.ReactNode }) {
    ...
    return (
      <>
          <div className={`fixed top-0 left-0 h-full z-20 bg-[#1A1A1A] text-white transition-all duration-300 transform 
            ...
            <div className="p-4 flex justify-center  h-full">
              <button onClick={closeBasket} className="absolute top-4 right-4 text-white text-2xl">
                &times;   
              </button>
      ...
      {/* Menu */}
      <div className={`fixed top-0 bottom-0 right-0 rounded-[10px] bg-[#1A1A1A] text-white p-6 transition-transform duration-300 transform  
